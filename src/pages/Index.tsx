    ...
    <div className="min-h-screen bg-background">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-muted-foreground max-w-md">
                  Platform AI yang membantu bisnis makanan mengurangi
                  pemborosan, menghemat biaya, dan berkontribusi untuk
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/input">
                  <Button
                    size="lg"
                    className="bg-gradient-to-r from-primary to-primary-glow shadow-elegant hover:shadow-glow transition-all duration-300"
                  >
                    Mulai Input Data
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Lebih dari sekedar tracking, Pangu memberikan dampak positif yang
              terukur
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center p-6 rounded-2xl bg-card/50 backdrop-blur-sm border border-border/30 hover:bg-card transition-all duration-300">
              ...
              <p className="text-muted-foreground">
                Hemat hingga 30% biaya operasional dengan pengurangan food waste
                yang optimal.
              </p>
            </div>
            ...
            <div className="text-center p-6 rounded-2xl bg-card/50 backdrop-blur-sm border border-border/30 hover:bg-card transition-all duration-300">
              ...
              <p className="text-muted-foreground">
                Kontribusi nyata untuk pengurangan emisi karbon dan pelestarian
                lingkungan.
              </p>
            </div>
            ...
            <div className="text-center p-6 rounded-2xl bg-card/50 backdrop-blur-sm border border-border/30 hover:bg-card transition-all duration-300">
              ...
              <p className="text-muted-foreground">
                Return on investment yang cepat dengan penghematan biaya yang
                signifikan.
              </p>
            </div>
            ...
            <div className="text-center p-6 rounded-2xl bg-card/50 backdrop-blur-sm border border-border/30 hover:bg-card transition-all duration-300">
              ...
              <p className="text-muted-foreground">
                Tingkatkan reputasi sebagai bisnis yang peduli sustainability
                dan lingkungan.
              </p>
            </div>
          </div>
                ...
                <div className="flex items-center">
                  <div className="flex-1 text-right pr-8">
                    <div className="bg-background p-6 rounded-2xl shadow-card border border-border/50">
                      ...
                      <p className="text-muted-foreground">
                        Catat sampah makanan harian Anda melalui halaman input
                        data. Sistem akan otomatis mengisi jenis dan harga
                        makanan.
                      </p>
                ...
                <div className="flex items-center">
                  ...
                  <div className="flex-1 text-left pl-8">
                    <div className="bg-background p-6 rounded-2xl shadow-card border border-border/50">
                      ...
                      <p className="text-muted-foreground">
                        Lihat analisis real-time dari data yang telah diinput.
                        Dashboard menampilkan tren, pola, dan area yang perlu
                        diperbaiki.
                      </p>
                ...
                <div className="flex items-center">
                  <div className="flex-1 text-right pr-8">
                    <div className="bg-background p-6 rounded-2xl shadow-card border border-border/50">
                      ...
                      <p className="text-muted-foreground">
                        Manfaatkan materi edukasi untuk memahami cara terbaik
                        mengurangi food waste di bisnis Anda.
                      </p>
                ...
                <div className="flex items-center">
                  ...
                  <div className="flex-1 text-left pl-8">
                    <div className="bg-background p-6 rounded-2xl shadow-card border border-border/50">
                      ...
                      <p className="text-muted-foreground">
                        Terapkan rekomendasi AI dan pantau progress pengurangan
                        food waste secara berkelanjutan.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <CardContent>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start">
                    <span className="text-primary mr-2">✓</span>1 User
                  </li>
                  <li className="flex items-start">
              ...
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Owner Warung Nasi Budi
                    </p>
                  </div>
                </div>
                <p className="text-muted-foreground italic mb-4">
                  "Pangu membantu saya mengurangi sampah makanan hingga 25%.
                  Sekarang saya bisa hemat Rp 1.5 juta per bulan dan lebih aware
              ...
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Manager Restoran Padang Sari
                    </p>
                  </div>
                </div>
                <p className="text-muted-foreground italic mb-4">
                  "Dashboard Pangu sangat membantu menganalisis pola pemborosan.
                  Rekomendasi AI-nya akurat dan mudah diimplementasikan. ROI-nya
                  cepat sekali!"
                </p>
                <div className="flex text-primary">⭐⭐⭐⭐⭐</div>
              </CardContent>
              ...
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Chef Executive Hotel Bintang Lima
                    </p>
                  </div>
                </div>
                <p className="text-muted-foreground italic mb-4">
                  "Sebagai chef, saya sangat peduli dengan food waste. Pangu
                  memberikan insight yang mendalam dan membantu hotel kami
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Solusi komprehensif untuk mengelola food waste dengan teknologi AI
              terdepan
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="shadow-card border-border/50 hover:shadow-glow transition-all duration-300 group">
              ...
              <CardContent>
                <CardDescription className="text-center">
                  Dashboard komprehensif yang menampilkan pola food waste, tren
                  kerugian finansial, dan rekomendasi AI untuk optimalisasi.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-card border-border/50 hover:shadow-glow transition-all duration-300 group">
              ...
              <CardContent>
                <CardDescription className="text-center">
                  Algoritma machine learning yang memberikan saran personalisasi
                  untuk mengurangi waste berdasarkan data historis bisnis Anda.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-card border-border/50 hover:shadow-glow transition-all duration-300 group">
              ...
              <CardContent>
                <CardDescription className="text-center">
                  Interface yang user-friendly dengan sistem keamanan data
                  tingkat enterprise. Input data dengan mudah, analisis
                  otomatis.
                </CardDescription>
              </CardContent>
            </Card>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              ...
              nyata dari penggunaan Pangu. Mulai perjalanan sustainability Anda
              hari ini.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/input">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-primary to-primary-glow shadow-elegant hover:shadow-glow"
                >
      ...
      <footer className="bg-foreground text-background py-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground">
            &copy; 2025 Pangu. Semua Hak Dilindungi. Bersama menciptakan dunia
            tanpa food waste.
          </p>
        </div>
      </footer>
